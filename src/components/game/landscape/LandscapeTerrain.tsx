export function LandscapeTerrain() {
  return (
    <>
      ...
      {/* Layer 4: Pure Flat Clean Grassland (Energetic Fantasy Green #2e6b34) */}
      <div className="landscape-layer layer-4-ground" aria-hidden="true">
        <svg viewBox="0 0 1000 400" preserveAspectRatio="none" width="100%" height="100%">
          {/* Flat Solid Energetic Green Grassland (y = 100 to 400) */}
          <rect x="0" y="100" width="1000" height="300" fill="#2e6b34" />
        </svg>
      </div>
    </>
  );
