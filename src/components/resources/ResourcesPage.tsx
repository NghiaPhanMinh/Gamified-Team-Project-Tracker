    ...
    <section className="resources-page" aria-labelledby="resources-title" style={{ width: "100%", margin: "0 auto" }}>
      <header className="focused-page-heading">
        <div>
          ...
          <p>Explore built-in methodology templates, phase structures, and project workflow guidance for your team.</p>
        </div>
      </header>

      <div className="resources-content-body" style={{ marginTop: "1.25rem" }}>
        <FrameworkLibrary onDuplicate={setFrameworkSeed} hideHeader />
      </div>
    </section>
  );
}
